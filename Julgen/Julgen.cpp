...
{
	static_cast<dae::Julgen*>(arg)->RunOneFrame();
}
#endif
...
dae::Julgen::Julgen(const std::filesystem::path &dataPath)
{
	PrintSDLVersion();
...
void dae::Julgen::Run(const std::function<void()>& load)
{
	load();
